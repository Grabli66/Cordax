...
var cordax_ui_App = function(data) {
	this.__tink_defaults2 = { title : tink_state__$Observable_Observable_$Impl_$["const"]("Cordax")};
...
cordax_ui_App.__name__ = true;
cordax_ui_App.__init = function(attributes,inst) {
	if(inst == null) {
		inst = new cordax_ui_App(attributes);
	} else {
		inst.__tink_init3(attributes);
	}
	return inst;
};
cordax_ui_App.__super__ = coconut_ui_View;
cordax_ui_App.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
	...
	,__tink_init3: function(attributes) {
		...
		this.__slots.title.setData(this1 == null ? this.__tink_defaults2.title : this1);
...
var cordax_ui_Text = function(data) {
	this.__tink_defaults0 = { };
	this.__slots = { text : new coconut_ui_tools_Slot(this,null)};
	this.__tink_init1(data);
	coconut_ui_View.call(this,$bind(this,this.render));
};
cordax_ui_Text.__name__ = true;
cordax_ui_Text.__init = function(attributes,inst) {
	if(inst == null) {
		inst = new cordax_ui_Text(attributes);
	} else {
		inst.__tink_init1(attributes);
	}
	return inst;
};
cordax_ui_Text.__super__ = coconut_ui_View;
cordax_ui_Text.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
		var __r = [];
...
mobile_Main.prototype = {
	render: function() {
		var this1 = { f : function() {
			return new cordax_ui_Text({ text : tink_state__$Observable_Observable_$Impl_$["const"]("Test text")});
		}};
		var app = new cordax_ui_App({ content : tink_state__$Observable_Observable_$Impl_$.auto(this1)});
		window.document.body.appendChild(app.toElement());
	}
	,start: function() {
		this.render();
	}
	,__class__: mobile_Main
};
