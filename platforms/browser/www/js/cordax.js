...
var Main = function() {
	this.drawerModel = new components_DrawerKey();
};
Main.__name__ = true;
Main.main = function() {
	var app = new Main();
...
Main.prototype = {
		...
		var this1 = { f : function() {
			var this2 = { f : function() {
				var this3 = { f : function() {
					var this4 = tink_state__$Observable_Observable_$Impl_$["const"]("img/menu.svg");
					var this5 = { f : function() {
						return function() {
							return _gthis.drawerModel.set_visible(true);
						};
					}};
	...
	,start: function() {
		window.document.addEventListener("deviceready",$bind(this,this.render),false);
	}
	,__class__: Main
};
Math.__name__ = true;
...
components_App.__init = function(attributes,inst) {
	if(inst == null) {
...
components_App.__super__ = coconut_ui_View;
components_App.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
		var tmp = window.document.getElementsByTagName("title");
...
components_AppBar.__init = function(attributes,inst) {
	if(inst == null) {
...
var components_DrawerKey = function(init) {
	...
	this.observables = { visible : this.__coco_visible, isInTransition : tink_state__$Observable_Observable_$Impl_$.map(this.__coco_transitionCount,tink_state__$Observable_Transform_$Impl_$.plain(function(count) {
		return count > 0;
	}))};
};
components_DrawerKey.__name__ = true;
components_DrawerKey.__interfaces__ = [coconut_data_Model];
components_DrawerKey.prototype = {
	get_visible: function() {
		return tink_state__$State_State_$Impl_$.get_value(this.__coco_visible);
	}
	,set_visible: function(param) {
		this.__coco_visible.set(param);
		return param;
	}
	...
	,__class__: components_DrawerKey
};
var components_Drawer = function(data) {
	var this1 = { f : function() {
...
components_Drawer.__init = function(attributes,inst) {
	if(inst == null) {
...
components_Drawer.__super__ = coconut_ui_View;
components_Drawer.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
		var _gthis = this;
		var style = tink_state__$State_State_$Impl_$.get_value(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.key.observe()).__coco_visible) ? "display: flex" : "display: none";
		var __r = [];
		var __ret = { className : vdom__$Attr_ClassName_$Impl_$.ofString("drawer"), style : vdom__$Style_Style_$Impl_$.ofString(style)};
		var attr = __ret;
		var __r1 = [];
		var __ret1 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("content")};
		var attr1 = __ret1;
		var __r2 = [];
		if(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.childs.observe()) != null) {
		...
		__r1.push(vdom_VDom.h("div",attr1,__r2));
		var __ret2 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("overflow"), onclick : function(event) {
			tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.key.observe()).set_visible(false);
		}};
		var __r3 = [];
...
components_IconButton.__init = function(attributes,inst) {
	if(inst == null) {
...
components_IconButton.__super__ = coconut_ui_View;
components_IconButton.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
		var _gthis = this;
		var __r = [];
		var __ret = { className : vdom__$Attr_ClassName_$Impl_$.ofString("icon-button"), src : tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.icon.observe()), onclick : tink_core__$Callback_Callback_$Impl_$.fromNiladic(tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.onclick.observe()))};
...
components_ListView.__init = function(attributes,inst) {
	if(inst == null) {
...
components_Scaffold.__init = function(attributes,inst) {
	if(inst == null) {
...
components_Scaffold.prototype = $extend(coconut_ui_View.prototype,{
	...
	,get_drawer: function() {
		return tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.drawer.observe());
	}
...
components_SimpleDrawerHeader.__init = function(attributes,inst) {
	if(inst == null) {
...
components_SimpleDrawerHeader.__super__ = coconut_ui_View;
components_SimpleDrawerHeader.prototype = $extend(coconut_ui_View.prototype,{
	render: function() {
		var _gthis = this;
		var __r = [];
		var __ret = { className : vdom__$Attr_ClassName_$Impl_$.ofString("drawer-simple-header")};
		var attr = __ret;
		var __r1 = [];
		var __ret1 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("inner")};
		var attr1 = __ret1;
		var __r2 = [];
		var __ret2 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("panel")};
		var attr2 = __ret2;
		var __r3 = [];
		var __ret3 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("photo"), src : "" + tink_state__$Observable_Observable_$Impl_$.get_value(_gthis.__slots.photo.observe())};
		__r3.push(vdom_VDom.h("img",__ret3));
		var __ret4 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("action-panel")};
		var attr3 = __ret4;
		var __r4 = [];
		if(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.actions.observe()) != null) {
			var _g = new tink_pure_NodeIterator(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.actions.observe()));
			while(_g.list.length > 0) {
				var action = _g.next();
				__r4.push(action);
			}
		}
		__r3.push(vdom_VDom.h("div",attr3,__r4));
		__r2.push(vdom_VDom.h("div",attr2,__r3));
		var __ret5 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("name")};
		var __r5 = [];
		__r5.push(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.name.observe()));
		__r2.push(vdom_VDom.h("div",__ret5,__r5));
		var __ret6 = { className : vdom__$Attr_ClassName_$Impl_$.ofString("email")};
		var __r6 = [];
		__r6.push(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.email.observe()));
		__r2.push(vdom_VDom.h("div",__ret6,__r6));
		__r1.push(vdom_VDom.h("div",attr1,__r2));
		__r.push(vdom_VDom.h("div",attr,__r1));
		return __r[0];
	}
	...
	,get_email: function() {
		return tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.email.observe());
	}
	,get_actions: function() {
		return tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.actions.observe());
	}
